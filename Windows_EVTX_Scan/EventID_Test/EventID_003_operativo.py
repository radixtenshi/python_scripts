...
def mostrar_menu():
    ...
    print("3 - EventID 4663 - Acceso a objeto")
...
def main():
    ...
    if opcion_evento == 1:
        ...
        clear_screen()
        print("Seleccione el sub-tipo:")
        print("1 - %%4416 - Read Data")
        print("2 - %%4418 - Append Data")
        print("3 - %%4417 - Write Data")  
        print("4 - %%4422 - Borrar un directorio")
        print("5 - %%1537 - Eliminar objeto (Archivo)")

        subtipo_4663 = int(input("Ingrese el número de sub-tipo: "))
        if subtipo_4663 == 1:
            subtipo = "%%4416"
        elif subtipo_4663 == 2:
            subtipo = "%%4418"
